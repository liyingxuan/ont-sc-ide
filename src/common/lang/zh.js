module.exports = {
  ...
  compile: {
    featuresLink: '形式化验证功能列表',
    compile: '编译',
    socket_compile: '形式化验证',
    waiting: '编译中...',
    checking: '验证中...',
    abi: 'ABI',
    outputInfo: 'AVM字节码',
    ...
    desp: '在区块链智能合约领域，形式化验证使用数学和逻辑语言精确定义智能合约、智能合约的运行环境以及智能合约的正确性和安全性，并通过数学证明和逻辑推理来证明智能合约的确满足其正确性和安全性定义。'
  },
  deploy: {
    selectWallet: '选择钱包文件',
    walletInfo: '钱包信息',
  ...
  ide:{
    ...
    saveSuccess: '保存成功',
    saveSuccessContent:'项目保存成功',
    deployedContract: '该合约已经部署过。'
  },
  projectEditor:{
