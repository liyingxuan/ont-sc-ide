module.exports = {
  ...
  login: {
    ...
    chooseFile: 'Please choose your Ontology wallet file',
    browse: 'Browse',
  ...
  compile: {
    featuresLink: 'Formal verification function list',
    compile: 'Compile',
    socket_compile: 'Formal verification',
    waiting: 'Waiting...',
    checking: 'Checking...',
    abi: 'ABI',
    ...
    desp: 'In the field of blockchain smart contracts, formal verification uses mathematical and logical languages ​​to precisely define smart contracts,The operating environment of smart contracts and the correctness and security of smart contracts, and through mathematical proof and logical reasoning to prove that smart contracts do meet their definition of correctness and security.'
  },
  deploy: {
  ...
  run: {
    ...
    comingSoon:'The language is not supported，please looking forward to it',
  ...
  ide:{
    ...
    saveSuccessContent:'Save project success',
    deployedContract: 'The contract has been deployed.',
    deployFalseNoOng: 'Please make sure there are enough ONGs in your account.',
    deployFalseNoEnoughLimit: 'Please input enough gas limit.'
  },
  projectEditor:{
