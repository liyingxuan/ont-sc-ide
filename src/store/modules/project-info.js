      ...
      return axios.get(url).then(function(response){
        ...
        if(response.data.data && $.isEmptyObject(response.data.data.code)){
          if(response.data.data.language === "CSharp"){
            ...
            response.data.data.code = ` `
          }else if(response.data.data.language === "ABI"){
            response.data.data.code = ` `
          }

          //ABI project
          if(!$.isEmptyObject(response.data.data.abi)&&!$.isEmptyObject(response.data.data.nvm_byte_code)){
            let info = {
